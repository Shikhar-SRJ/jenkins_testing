...
class SurfShopTests(unittest.TestCase):
    ...
    def test_add_too_many_surfboards(self):
        self.assertRaises(m.TooManyBoardsError, self.cart.add_surfboards, 5)
    ...
    def test_add_invalid_checkout_date(self):
        ...
        self.assertRaises(m.CheckoutDateError, self.cart.set_checkout_date, date)
